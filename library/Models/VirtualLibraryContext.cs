...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost;Database=VirtualLibrary;Trusted_Connection=False;password=1234;user=stav;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BooksList>(entity =>
            {
                entity.HasKey(e => e.BookId)
                    .HasName("PK__BooksLis__8BE5A10DF5129E6C");
...
// using (SqlConnection con = new SqlConnection("Server=localhost;Database=VirtualLibrary;Trusted_Connection=False;password=1234;user=stav;"))
//  {
//     using (SqlCommand cmd = new SqlCommend("<myProc>",con))
//     {
//         cmd.CpmmandType = CommandType.StoredProcedure;
//         cmd.Parmeters.addWithValue("@<param>", param )
//     }
// }
